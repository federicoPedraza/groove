...
export const WOUNDED_STATE_CLASSES =
  "border-rose-800 bg-rose-900 text-white [&>svg]:text-white dark:border-rose-800 dark:bg-rose-900 dark:text-white dark:[&>svg]:text-white";
export const DEFEATED_STATE_CLASSES =
  "border-emerald-800 bg-emerald-900 text-white [&>svg]:text-white dark:border-emerald-800 dark:bg-emerald-900 dark:text-white dark:[&>svg]:text-white";
export const BLOCKED_STATE_CLASSES =
  "border-amber-800 bg-amber-900 text-white [&>svg]:text-white dark:border-amber-800 dark:bg-amber-900 dark:text-white dark:[&>svg]:text-white";
export const FORGOTTEN_STATE_CLASSES =
  "border-zinc-800 bg-zinc-900 text-white [&>svg]:text-white dark:border-zinc-800 dark:bg-zinc-900 dark:text-white dark:[&>svg]:text-white";

export const READY_STATUS_CLASSES =
  "border-green-700/30 bg-green-500/15 text-green-800 dark:border-green-400/70 dark:text-white dark:[&>svg]:text-green-100";
export const PAUSED_STATUS_CLASSES =
  "border-yellow-700/35 bg-yellow-500/15 text-yellow-900 dark:border-yellow-400/70 dark:text-white dark:[&>svg]:text-yellow-100";
export const CORRUPTED_STATUS_CLASSES =
  "border-orange-700/35 bg-orange-500/15 text-orange-900 dark:border-orange-400/70 dark:text-white dark:[&>svg]:text-orange-100";
export const DELETED_STATUS_CLASSES =
  "border-slate-600/35 bg-slate-500/10 text-slate-700 dark:border-slate-300/60 dark:text-white dark:[&>svg]:text-slate-100";

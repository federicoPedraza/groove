...
import type { RuntimeStateRow, WorktreeRow } from "@/src/components/pages/dashboard/types";
        ...
        <TableCell className="text-right">
          <TooltipProvider>
            <WorktreeRowActions
              ...
              isSummarizePending={row.worktreeId ? summarizingWorktreeIds.has(row.worktreeId) : false}
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="inline-flex items-center gap-1">
                        {!isDeletedWorktreesSection && (() => {
                          ...
                          const isSectionSummarizing = summarizingSectionKeys.has(section.key);

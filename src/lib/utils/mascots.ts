...
export const MASCOT_DEFINITIONS: readonly MascotDefinition[] = [
  ...
  },
  {
    ...
    sprites: {
      idle: {
        src: "/greptile/greptile.png",
        frameCount: 8,
        frameWidthPx: 102,
        frameHeightPx: 110,
        frameYOffsetPx: 0,
        renderedHeightPx: 110,
        renderScale: 0.8,
        animationSpeedMultiplier: 3.5,
      },
    },
  },
  {
    ...
    sprites: {
      idle: {
        src: "/trapped%20greptile/trapped%20greptile.png",
        frameCount: 16,
        frameWidthPx: 65,
        frameHeightPx: 103,
        frameYOffsetPx: 0,
        renderedHeightPx: 103,
        renderScale: 1,
  ...
  },
  {
    ...
    sprites: {
      idle: {
        src: "/bristleback/bristleback.png",
        frameCount: 6,
        frameWidthPx: 85,
        frameHeightPx: 78,
        frameYOffsetPx: 0,

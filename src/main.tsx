...
const SENTRY_DSN =
  "https://44bc6cff7295f7123a4bceaaa0b6e525@o4510958851063808.ingest.us.sentry.io/4510958860238848";
...
function initSentryIfTelemetryEnabled(): void {
  ...
  Sentry.init({
    ...
    release:
      ...
      `groove-frontend@${import.meta.env.MODE}`,
...
const disableStrictModeForPerf =
...
async function renderApp(): Promise<void> {
  ...
  createRoot(document.getElementById("root")!).render(
    disableStrictModeForPerf ? appTree : <StrictMode>{appTree}</StrictMode>,
  );
}
